...
describe('Authentication', () => {
    ...
    it('can save an auth token ', () => __awaiter(void 0, void 0, void 0, function* () {
        let publicAddress = user.address;
        let upsert = yield index_1.default.upsertNewAuthenticationTokenForAccount(mongoInterface, publicAddress);
        //let activeChallenge = await DegenAuth.findActiveChallengeForAccount(mongoInterface, publicAddress)
        (0, chai_1.expect)(upsert).to.exist;
        (0, chai_1.expect)(upsert.token).to.exist;
        ...
        let matchingToken = yield index_1.default.validateAuthenticationTokenForAccount(mongoInterface, publicAddress, upsert.token);
